...
--
-- Seit dem Umzug in die gemeinsame Datenbank "spiele" ist diese Absicherung
-- nicht mehr nur Vorsorge, sondern der Grund, warum die Datei ueberhaupt noch
-- laufen darf: der ganze Bestand steht dort bereits. Ohne WHERE NOT EXISTS
-- stuende nach einem Migrationslauf jeder Rekord ein zweites Mal in der
-- Tabelle. An der Logik wurde beim Umzug darum nichts geaendert, nur die
-- Tabellennamen tragen jetzt den Praefix "zehner_" (warum, steht in
-- 0001_zehner_schema.sql).
...
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'leicht', 2560, 'CHR', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'leicht' AND punkte = 2560 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'leicht', 2580, 'CHR', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'leicht' AND punkte = 2580 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'leicht', 2694, '', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'leicht' AND punkte = 2694 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'leicht', 2795, '', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'leicht' AND punkte = 2795 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'leicht', 3077, 'TAB', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'leicht' AND punkte = 3077 AND herkunft = 'abacus');

-- mittel: 3959, 4155/CHR, 4169
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'mittel', 3959, '', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'mittel' AND punkte = 3959 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'mittel', 4155, 'CHR', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'mittel' AND punkte = 4155 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'mittel', 4169, '', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'mittel' AND punkte = 4169 AND herkunft = 'abacus');

-- schwer: 4720/SES, 4775/SES, 4862/SES
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'schwer', 4720, 'SES', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'schwer' AND punkte = 4720 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'schwer', 4775, 'SES', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'schwer' AND punkte = 4775 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'schwer', 4862, 'SES', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'schwer' AND punkte = 4862 AND herkunft = 'abacus');

-- klassisch: 1194/CHR, 1634/SES
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'klassisch', 1194, 'CHR', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'klassisch' AND punkte = 1194 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'klassisch', 1634, 'SES', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'klassisch' AND punkte = 1634 AND herkunft = 'abacus');

-- endlos: 2249/SES, 2279/SES, 2288/SES, 2321/SES, 12503/SES
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'endlos', 2249, 'SES', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'endlos' AND punkte = 2249 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'endlos', 2279, 'SES', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'endlos' AND punkte = 2279 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'endlos', 2288, 'SES', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'endlos' AND punkte = 2288 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'endlos', 2321, 'SES', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'endlos' AND punkte = 2321 AND herkunft = 'abacus');
INSERT INTO zehner_rekorde (stufe, punkte, kuerzel, wann, herkunft)
  SELECT 'endlos', 12503, 'SES', NULL, 'abacus' WHERE NOT EXISTS
    (SELECT 1 FROM zehner_rekorde WHERE stufe = 'endlos' AND punkte = 12503 AND herkunft = 'abacus');
...
INSERT INTO zehner_zaehler (name, wert) VALUES ('spiele', 115) ON CONFLICT(name) DO NOTHING;
INSERT INTO zehner_zaehler (name, wert) VALUES ('siege', 75) ON CONFLICT(name) DO NOTHING;
