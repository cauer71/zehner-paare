...
const TEXTE = {
  ...
  de: {
    ...
    'a11y.cardScore': 'Weltrekorde anzeigen',
    'a11y.cardLeft': 'Schwierigkeit ändern',
    ...
    'msg.refilled': '{n} Zahlen · noch {left}×',
    'msg.refillWorth': ' · Treffer {p} %',
    ...
    'set.topTen': 'Die besten Zehn · {stufe}',
    'set.topNone': 'Auf dieser Stufe hat noch niemand mit Kürzel gespielt.',
    'set.worldOff': 'Weltweit ist ausgeschaltet.',
    'set.worldOld': '· vor {min} Min. geholt',
    'set.groupApp': 'App',
    ...
    'end.wonWorld': '{label} · neuer Weltrekord, vorher {prev}.',
    'end.wonWorldFirst': '{label} · der erste Weltrekord dieser Stufe.',
  ...
  it: {
    ...
    'a11y.cardScore': 'Mostra i record mondiali',
    'a11y.cardLeft': 'Cambia difficoltà',
    ...
    'msg.refilled': '{n} numeri · ancora {left}×',
    'msg.refillWorth': ' · mosse {p} %',
    ...
    'set.topTen': 'I migliori dieci · {stufe}',
    'set.topNone': 'A questo livello non ha ancora giocato nessuno con una sigla.',
    'set.worldOff': 'Il conteggio mondiale è spento.',
    'set.worldOld': '· letto {min} min fa',
    'set.groupApp': 'App',
    ...
    'end.wonWorld': '{label} · nuovo record mondiale, prima era {prev}.',
    'end.wonWorldFirst': '{label} · il primo record mondiale di questo livello.',
  ...
  en: {
    ...
    'a11y.cardScore': 'Show world records',
    'a11y.cardLeft': 'Change difficulty',
    ...
    'msg.refilled': '{n} numbers · {left}× left',
    'msg.refillWorth': ' · matches {p} %',
    ...
    'set.topTen': 'The best ten · {stufe}',
    'set.topNone': 'Nobody has played this level with initials yet.',
    'set.worldOff': 'Worldwide counting is off.',
    'set.worldOld': '· fetched {min} min ago',
    'set.groupApp': 'App',
    ...
    'end.wonWorld': '{label} · new world record, previously {prev}.',
    'end.wonWorldFirst': '{label} · the first world record on this level.',
